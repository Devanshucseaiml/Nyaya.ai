...
(NULL, 'Adv. Priya Sharma', 'priya.sharma@example.com', '+91 98765 43210', 'Experienced criminal defense lawyer with 12 years of practice. Specialized in white-collar crimes and corporate fraud cases.', 12, 'BCI/2011/12345', ARRAY['Criminal Law', 'Corporate Law'], ARRAY['Hindi', 'English', 'Punjabi'], 'New Delhi', 2500, true, true),
(NULL, 'Adv. Rajesh Kumar', 'rajesh.kumar@example.com', '+91 87654 32109', 'Family law specialist helping families navigate divorce, custody, and property disputes with compassion and expertise.', 8, 'BCI/2015/67890', ARRAY['Family Law', 'Property Law'], ARRAY['Hindi', 'English', 'Bengali'], 'Mumbai', 2000, true, true),
(NULL, 'Adv. Meera Patel', 'meera.patel@example.com', '+91 76543 21098', 'Corporate lawyer with extensive experience in mergers, acquisitions, and startup legal matters.', 15, 'BCI/2008/11111', ARRAY['Corporate Law', 'Intellectual Property'], ARRAY['Hindi', 'English', 'Gujarati'], 'Bangalore', 3000, true, true),
(NULL, 'Adv. Arjun Singh', 'arjun.singh@example.com', '+91 65432 10987', 'Labor law expert fighting for workers rights and handling employment disputes across various industries.', 10, 'BCI/2013/22222', ARRAY['Labor Law', 'Constitutional Law'], ARRAY['Hindi', 'English', 'Marathi'], 'Pune', 1800, true, true),
(NULL, 'Adv. Kavya Reddy', 'kavya.reddy@example.com', '+91 54321 09876', 'Tax law specialist helping individuals and businesses with tax planning, compliance, and dispute resolution.', 6, 'BCI/2017/33333', ARRAY['Tax Law', 'Corporate Law'], ARRAY['Hindi', 'English', 'Telugu'], 'Hyderabad', 2200, true, true),
(NULL, 'Adv. Vikram Joshi', 'vikram.joshi@example.com', '+91 43210 98765', 'Property law expert with deep knowledge of real estate transactions, land disputes, and property documentation.', 14, 'BCI/2009/44444', ARRAY['Property Law', 'Constitutional Law'], ARRAY['Hindi', 'English', 'Marathi'], 'Mumbai', 2800, true, true)
